...
import { Box, Card, CardBody, CardFooter,
         Button, Text }
         from 'grommet';
    ...
    <>
      ...
      >
        <CardBody>
          ...
          <Box pad="small">
            <HeaderContent title={title} weight={600} textTransform="uppercase"/>
            ...
            <HeaderContent title="Colors" textTransform="uppercase" weight={600}>
              <RadioGroupCustom checked={checked} setChecked={setChecked} items={itemsMore}/>
            </HeaderContent>
          </Box>
        </CardBody>
        <CardFooter pad="small" background="light-2" direction="row" justify="center">
