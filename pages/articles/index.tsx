...
const articles = {
  item: {
    ...
    textDescription:
      "Conjunto para bebe de 6 piezas, perfecto para cualquier ocasión.",
    items: ["XS", "S", "M", "L", "XL"],
  ...
  return (
    <Box>
      <Box flex direction="row" justify="between" pad={{ horizontal: "small" }}>
        <Heading title="Articles" level={3}>
          Articles
        </Heading>
        <Button
          icon={<AddCircle size="medium" color="#0070f3" />}
          onClick={() => {}}
          size="medium"
          plain={true}
          style={{ height: 25, borderRadius: "50%", textAlign: "center" }}
